...
function Library:CreateWindow(a)
  ...
  CreditText.FontFace = Font.new("rbxasset://fonts/families/GothamSSm.json", Enum.FontWeight.Bold, Enum.FontStyle.Normal)
	...
	CreditText.Size = UDim2.new(0, 53, 0, 17)
   ...
   CreditText.TextXAlignment = Enum.TextXAlignment.Left
	...
	function Library.Page:AddPage(a)
     ...
     ScrollingFrame1["Transparency"] = 1
		...
		ScrollingFrame1["BorderColor3"] = Color3.fromRGB(255, 0, 127)
    ...
    ScrollingFrame2["Transparency"] = 1
		...
		ScrollingFrame2["BorderColor3"] = Color3.fromRGB(255, 0, 127)
		...
		function Library.Function:CreateButton(s, info)
			...
			Buttons["c0"]["Size"] = UDim2.new(0.3, 0, 0.40, 0)
    ...
    Sliders["a8"] = Instance.new("Frame", Sliders["a3"])
    Sliders["a8"].BackgroundColor3 = Color3.fromRGB(213, 213, 213)
    Sliders["a8"].AnchorPoint = Vector2.new(0.5, 0.5)
    Sliders["a8"].Size = UDim2.new(0.75, 0, 0.15, 0)
    Sliders["a8"].Position = UDim2.new(0.4, 0, 0.76429, 0)
       ...
       CONTAINER["Transparency"] = 1
			...
			CONTAINER["BorderColor3"] = Color3.fromRGB(255, 0, 127)
